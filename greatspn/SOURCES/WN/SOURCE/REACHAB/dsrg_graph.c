...
void print_dsrg(FILE* dsrg, State source, 
  ...
  if(output_flag){
    if(flag==1) {
      ...
      fprintf(dsrg,"S%d [fontsize=7, label=\"S%d\[%d\]: %s (dead)\"];\n",
      ...
      fprintf(dsrg,"S%d [fontsize=7, label=\"S%d\[%d\]: %s\"];\n",
	      source->marking->cont_tang,source->marking->cont_tang,
	      source->Parent->marking->cont_tang,
	      st);
      free(st)   ;
      ...
      if(!out_mc){
	if(flag==2) 
	  fprintf(dsrg,"S%d -> S%d  [style=dashed];\n",
		  source->marking->cont_tang, 
		  dests->marking->cont_tang);
	else
	  fprintf(dsrg,"S%d -> S%d ;\n",
		  source->marking->cont_tang, 
		  dests->marking->cont_tang);
      } else{
	if(flag==2)
	  fprintf(dsrg,"S%d -> S%d [style=dashed,fontsize=10, label=\"%g\"];\n",
		  source->marking->cont_tang,
		  dests->marking->cont_tang,rate);
	else
	  fprintf(dsrg,"S%d -> S%d [ fontsize=10, label=\"%g\"];\n",
		  source->marking->cont_tang,
		  dests->marking->cont_tang,rate);
	...
	fprintf(dsrg,"%d %d %d %d %d 1 %g %d %d %d %d %d \n",
		source->Parent->marking->cont_tang,
	...
	fprintf(dsrg,"%d %d %d %d %d 2 %g %d %d %d %d %d \n",
		source->Parent->marking->cont_tang,
		source->Parent->marking->ofset,
		source->marking->cont_tang, 
		source->marking->ofset,
    ...
    if(flag==2)
      	fprintf(dsrg,"%d %d %d %d %d 3 %g %d %d %d %d %d \n",
		source->Parent->marking->cont_tang,
		source->Parent->marking->ofset,
		source->marking->cont_tang, 
		source->marking->ofset,
