...
then
	...
	echo $1GL
	$GSPN2HOME2/MDWNSRG $1GL -w 0.0
else
	echo "# Generate the RG for the model: " 
	echo $1GL	
	$GSPN2HOME2/MDWNRG $1GL -w 0.0
fi
...
$GSPN2HOME2/RG2RRG $1GL -f -p -h$horizon -a -d -t
...
then
	...
	echo
	$GSPN2HOME2/MDP $1GL -g
else
	echo "# Solve the MDP without GUI"
	echo
	$GSPN2HOME2/MDP $1GL -o -t
fi
